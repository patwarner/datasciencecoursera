...
confusionMatrix(rf.pred.trn, trn.dataframe$target.trn) #100% accuracy
...
rf.cv.mod
confusionMatrix(rf.cv.pred.trn, trn.dataframe$target.trn) #100% accuracy
...
The final project was successfully completed. Author felt that 99.8% 10 Fold CVaccuracy was sufficient to try the model
on the testing dataset. Submitted testing set had a 100% accuracy from the submission feedback.+
